...
- **Merge rule:** new non-null value wins; null never erases existing data. Exceptions: `order_confirmation` `orderTotal` is authoritative once present; `orderDate` is write-once (see below), not last-write-wins.
